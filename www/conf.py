...
BLOG_AUTHOR = "Adrián Ribao"
BLOG_TITLE = "Aprendiendo a correr"
# This is the main URL for your site. It will be used
# in a prominent link
SITE_URL = "http://aprendiendoacorrer.es/"
# This is the URL where nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://getnikola.com/"
BLOG_EMAIL = "adrian@adrima.es"
BLOG_DESCRIPTION = "Mis aventuras aprendiendo a correr"
...
# is in the manual.
COMMENT_SYSTEM_ID = "aprendiendoacorrer"
...
<script type="text/javascript">
  var _paq = _paq || [];
  _paq.push(["setCookieDomain", "*.aprendiendoacorrer.es"]);
  _paq.push(["trackPageView"]);
  _paq.push(["enableLinkTracking"]);

  (function() {
    var u=(("https:" == document.location.protocol) ? "https" : "http") + "://piwik.adrima.es/";
